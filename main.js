...
$( document ).ready( function() {
    ...
    function newActivity() {
        ...
        $( '.activityContent' ).hide().prepend('<div class="live-stats">' +
           '<ul>' +
           		...
           		'<li><span class="text-green"><image class="fa img-responsive" src="resource1-1.png"/*tpa=http://darkwebgaming.info/pubg-mobile-hack-uc/js/img/resource1.png*/> '+diamondsRand+'</span>' +
    ...
    function progressBar() {
        ...
        function frame() {
            ...
            if( width == 50 ) $( '.load-textJS' ).html( 'GET -> <span class="text-green">UC</span>' );
